...
func (s *handler) Create(w http.ResponseWriter, request *http.Request) {
...
func (s *handler) Update(w http.ResponseWriter, request *http.Request) {
	customerID := request.Header.Get("Tenant-ID")
...
func (s *handler) readMicroserviceBase(request *http.Request, logContext *logrus.Entry) (requestBytes []byte, microserviceBase platform.HttpMicroserviceBase, err error) {
...
func (s *handler) GetByApplicationID(w http.ResponseWriter, r *http.Request) {
	customerID := r.Header.Get("Tenant-ID")
	tenantInfo, err := s.gitRepo.GetTerraformTenant(customerID)
	if err != nil {
		// TODO handle not found
...
func (s *handler) GetLiveByApplicationID(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	applicationID := vars["applicationID"]
...
func (s *handler) GetPodStatus(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	applicationID := vars["applicationID"]
	microserviceID := vars["microserviceID"]
	environment := strings.ToLower(vars["environment"])
...
func (s *handler) GetPodLogs(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	applicationID := vars["applicationID"]
...
func (s *handler) GetConfigMap(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	applicationID := vars["applicationID"]
...
func (s *handler) GetSecret(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	applicationID := vars["applicationID"]
...
func (s *handler) CanI(w http.ResponseWriter, r *http.Request) {
