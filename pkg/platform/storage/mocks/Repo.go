...
// CheckAutomationEnabledViaCustomer provides a mock function with given fields: customer, applicationID, environment
func (_m *Repo) CheckAutomationEnabledViaCustomer(customer platform.StudioConfig, applicationID string, environment string) bool {
	ret := _m.Called(customer, applicationID, environment)

	var r0 bool
	if rf, ok := ret.Get(0).(func(platform.StudioConfig, string, string) bool); ok {
		r0 = rf(customer, applicationID, environment)
	} else {
		r0 = ret.Get(0).(bool)
	}
