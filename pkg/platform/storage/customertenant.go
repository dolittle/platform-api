...
func GetCustomerTenants(application JSONApplication2) []platform.CustomerTenantInfo {
...
func GetCustomerTenantsByEnvironment(application JSONApplication2, environment string) []platform.CustomerTenantInfo {
	return funk.FlatMap(application.Environments, func(applicationEnvironment JSONEnvironment2) []platform.CustomerTenantInfo {
