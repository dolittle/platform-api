...
// NewRepoRoleBinding creates a new instance of RepoRoleBinding. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRepoRoleBinding(t testing.TB) *RepoRoleBinding {
