...
type mockConstructorTestingTNewRepoIngress interface {
	mock.TestingT
	Cleanup(func())
}

// NewRepoIngress creates a new instance of RepoIngress. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewRepoIngress(t mockConstructorTestingTNewRepoIngress) *RepoIngress {
	mock := &RepoIngress{}
	mock.Mock.Test(t)
