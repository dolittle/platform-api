...
type mockConstructorTestingTNewRepoDeployment interface {
	mock.TestingT
	Cleanup(func())
}

// NewRepoDeployment creates a new instance of RepoDeployment. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewRepoDeployment(t mockConstructorTestingTNewRepoDeployment) *RepoDeployment {
	mock := &RepoDeployment{}
	mock.Mock.Test(t)
