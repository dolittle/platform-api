...
// RepoNamspace is an autogenerated mock type for the RepoNamspace type
type RepoNamspace struct {
	mock.Mock
}

// GetNamespaces provides a mock function with given fields:
func (_m *RepoNamspace) GetNamespaces() ([]v1.Namespace, error) {
	ret := _m.Called()
...
func (_m *RepoNamspace) GetNamespacesWithApplication() ([]v1.Namespace, error) {
	ret := _m.Called()
...
func (_m *RepoNamspace) GetNamespacesWithOptions(opts metav1.ListOptions) ([]v1.Namespace, error) {
	ret := _m.Called(opts)
