...
type mockConstructorTestingTNewRepoNamespace interface {
	mock.TestingT
	Cleanup(func())
}

// NewRepoNamespace creates a new instance of RepoNamespace. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewRepoNamespace(t mockConstructorTestingTNewRepoNamespace) *RepoNamespace {
	mock := &RepoNamespace{}
	mock.Mock.Test(t)
