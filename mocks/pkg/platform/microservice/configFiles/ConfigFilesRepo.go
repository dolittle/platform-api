...
type mockConstructorTestingTNewConfigFilesRepo interface {
	mock.TestingT
	Cleanup(func())
}

// NewConfigFilesRepo creates a new instance of ConfigFilesRepo. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewConfigFilesRepo(t mockConstructorTestingTNewConfigFilesRepo) *ConfigFilesRepo {
