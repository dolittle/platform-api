...
type mockConstructorTestingTNewK8sResource interface {
	mock.TestingT
	Cleanup(func())
}

// NewK8sResource creates a new instance of K8sResource. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewK8sResource(t mockConstructorTestingTNewK8sResource) *K8sResource {
	mock := &K8sResource{}
	mock.Mock.Test(t)
