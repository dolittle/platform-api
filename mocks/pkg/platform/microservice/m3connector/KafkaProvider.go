...
type mockConstructorTestingTNewKafkaProvider interface {
	mock.TestingT
	Cleanup(func())
}

// NewKafkaProvider creates a new instance of KafkaProvider. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewKafkaProvider(t mockConstructorTestingTNewKafkaProvider) *KafkaProvider {
	mock := &KafkaProvider{}
	mock.Mock.Test(t)
