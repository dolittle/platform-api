...
// NewRepoCustomerTenants creates a new instance of RepoCustomerTenants. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRepoCustomerTenants(t testing.TB) *RepoCustomerTenants {
