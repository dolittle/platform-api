...
// NewRepoCustomer creates a new instance of RepoCustomer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRepoCustomer(t testing.TB) *RepoCustomer {
	mock := &RepoCustomer{}
	mock.Mock.Test(t)
