...
type mockConstructorTestingTNewRepoMicroservice interface {
	mock.TestingT
	Cleanup(func())
}

// NewRepoMicroservice creates a new instance of RepoMicroservice. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewRepoMicroservice(t mockConstructorTestingTNewRepoMicroservice) *RepoMicroservice {
	mock := &RepoMicroservice{}
	mock.Mock.Test(t)
