...
// CommitPathAndPush provides a mock function with given fields: path, msg
func (_m *Repo) CommitPathAndPush(path string, msg string) error {
...
func (_m *Repo) GetApplication(customerID string, applicationID string) (platformstorage.JSONApplication, error) {
...
func (_m *Repo) GetApplications(customerID string) ([]platformstorage.JSONApplication, error) {
...
func (_m *Repo) GetCustomers() ([]platform.Customer, error) {
	ret := _m.Called()
...
// GetDirectory provides a mock function with given fields:
func (_m *Repo) GetDirectory() string {
	ret := _m.Called()
...
func (_m *Repo) SaveApplication(application platformstorage.JSONApplication) error {
...
func (_m *Repo) SaveCustomer(customer platformstorage.JSONCustomer) error {
