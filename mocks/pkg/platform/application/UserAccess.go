...
type mockConstructorTestingTNewUserAccess interface {
	mock.TestingT
	Cleanup(func())
}

// NewUserAccess creates a new instance of UserAccess. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewUserAccess(t mockConstructorTestingTNewUserAccess) *UserAccess {
	mock := &UserAccess{}
	mock.Mock.Test(t)
