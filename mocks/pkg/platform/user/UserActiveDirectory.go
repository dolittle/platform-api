...
type mockConstructorTestingTNewUserActiveDirectory interface {
	mock.TestingT
	Cleanup(func())
}

// NewUserActiveDirectory creates a new instance of UserActiveDirectory. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewUserActiveDirectory(t mockConstructorTestingTNewUserActiveDirectory) *UserActiveDirectory {
