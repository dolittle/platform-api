...
// NewKratosClientV5 creates a new instance of KratosClientV5. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewKratosClientV5(t testing.TB) *KratosClientV5 {
	mock := &KratosClientV5{}
	mock.Mock.Test(t)
